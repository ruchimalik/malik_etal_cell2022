function plots = slmkplots_multi(varargin)
...
%
% $Id: slmkplots.m 485 2008-07-04 00:09:39Z tjd $
...
for k = 1:length(plotargs);
  ...
  switch plots{k}.type
   case 'parmest'
    ...
    plots{k}.dat.epochi = ''; % provided by slp
    plots{k}.dat.clnos = [];
    plots{k}.dat.clperm = [];
    ...
    plots{k}.tunecurveopt = mktunecurveopt_multi();
