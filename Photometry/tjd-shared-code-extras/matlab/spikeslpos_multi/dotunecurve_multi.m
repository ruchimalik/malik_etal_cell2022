function [tc occ] = dotunecurve_multi(varargin)
...
%
% $Id: dotunecurve.m 511 2009-03-15 02:06:35Z tjd $
...
% constants
  ...
  a.opt = mktunecurveopt_multi('template',a.opt);
  ...
  allpos = getepd(a.e.epoch(a.opt.runepochi).pos, 'time', a.opt.tuneparams{:});
  ...
  for j = 1:ncls,
    ...
    cl_data = getepdi(a.e.epoch(a.opt.runepochi).pos, ...
                      getepd(a.e.epoch(a.opt.runepochi).cl(a.clnos(j)),'posi'), ...
