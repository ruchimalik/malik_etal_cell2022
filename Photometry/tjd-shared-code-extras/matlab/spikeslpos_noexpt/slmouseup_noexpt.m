function slmouseup_noexpt(fig)
% SLMOUSEUP - do zoom for mouse drag zoom
%
% $Id: slmouseup.m 419 2007-08-29 23:16:05Z tjd $
...
if replot,
  ...
  if ~sld.prefmousezoom,
    ...
    % mash xlim to do a pretty pan/zoom
    xl = xlim;
    
    switch sld.lastsel,

      case {'normal' 'extend'}
        % zoom in or pan, redraw after
